...
_G.packer_plugins = {
  ...
  ["cmp-tabnine"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/cmp-tabnine",
  ...
  ["lsp_extensions.nvim"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/lsp_extensions.nvim",
  ...
  neoformat = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/neoformat",
    url = "https://github.com/sbdchd/neoformat"
  },
  neogit = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/neogit",
  ...
  ["symbols-outline.nvim"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/symbols-outline.nvim",
  ...
  ["typescript.nvim"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/typescript.nvim",
